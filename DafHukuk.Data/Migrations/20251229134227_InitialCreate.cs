        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title_TR = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    Slug_TR = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Slug_EN = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Slug_AR = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Biography_TR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Biography_EN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Biography_AR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SolutionPartners", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug_TR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Slug_EN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Slug_AR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedDate", "IsActive", "Name_AR", "Name_EN", "Name_TR" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 29, 13, 42, 27, 458, DateTimeKind.Utc).AddTicks(2986), true, "فعاليات", "Events", "Etkinlikler" },
                    { 2, new DateTime(2025, 12, 29, 13, 42, 27, 458, DateTimeKind.Utc).AddTicks(2988), true, "منشورات", "Publications", "Yayınlar" },
                    { 3, new DateTime(2025, 12, 29, 13, 42, 27, 458, DateTimeKind.Utc).AddTicks(2990), true, "خدماتنا", "Our Services", "Hizmetlerimiz" }
                });
